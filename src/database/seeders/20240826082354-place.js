const places = [
  {
    ...
    img: 'https://example.com/kiyovu_hill.jpg',
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    img: 'https://example.com/volcanoes_park.jpg',
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    img: 'https://example.com/akagera_game_lodge.jpg',
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    img: 'https://example.com/huye_mountain.jpg',
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    img: 'https://example.com/lake_kivu.jpg',
    createdAt: new Date(),
    updatedAt: new Date()
  }
];
